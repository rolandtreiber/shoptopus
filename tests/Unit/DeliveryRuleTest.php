...
class DeliveryRuleTest extends TestCase
{
    ...
    /** @test */
    public function it_has_a_postcodes_field()
    {
        $this->assertNotNull($this->delivery_rule->postcodes);
    }

    /** @test */
    public function it_has_a_min_weight_field()
    {
        $this->assertNotNull($this->delivery_rule->min_weight);
    }

    /** @test */
    public function it_has_a_max_weight_field()
    {
        $this->assertNotNull($this->delivery_rule->max_weight);
    }

    /** @test */
    public function it_has_a_min_distance_field()
    {
        $this->assertNotNull($this->delivery_rule->min_distance);
    }

    /** @test */
    public function it_has_a_max_distance_field()
    {
        $this->assertNotNull($this->delivery_rule->max_distance);
    }

    /** @test */
    public function it_has_a_distance_unit_field()
    {
    ...
    /** @test */
    public function it_belongs_to_a_delivery_type()
    {
