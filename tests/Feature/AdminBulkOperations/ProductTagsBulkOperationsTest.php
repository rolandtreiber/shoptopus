 ...
 */
class ProductTagsBulkOperationsTest extends TestCase
{
    /**
     * @test
     */
     ...
     * @test
     */
    public function test_bulk_product_tags_availability_update_not_found_db_changes_rolled_back()
    {
        $this->assertTrue(true);
    }
     ...
     * @test
     */
    public function test_bulk_product_tags_delete_not_found_db_changes_rolled_back()
    {
        $this->assertTrue(true);
    }
}
